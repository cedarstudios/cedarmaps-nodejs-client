...
test('Should not accept odd number or invalid points as argument', t => {
	const Distance = require('../../v1/distance')({RequestHelper: CreateValidRequestMock({ignore: true})})
	t.throws(() => Distance(), Error)
	t.throws(() => Distance(1), Error)
	t.throws(() => Distance([validPoint1]), Error)
	t.throws(() => Distance([validPoint1, {lat: 1}]), Error)
